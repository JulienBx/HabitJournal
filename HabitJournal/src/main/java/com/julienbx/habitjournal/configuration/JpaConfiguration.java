package com.julienbx.habitjournal.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.julienbx.habitjournal.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.julienbx.habitjournal.model" });
